...
import polaroid from "../assets/foto-pola.png";
...
<template>
    ...
    <div class="row g-5 justify-content-center align-items-center">
      ...
      <div class="col-xl-8 col-lg-7 col-md-12 col-sm-12 col-12 px-4">
        ...
        diseñados y fabricados con cuidado artesanal. Cada artículo que sale de
        mi taller es una obra de arte en sí misma, personalizada de acuerdo con
        las historias y los sueños de mis clientes.</p>
